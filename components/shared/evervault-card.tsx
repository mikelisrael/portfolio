  ...
  return (
    ...
    >
      <div
        ...
        className="group/card relative flex h-full w-full items-center justify-center overflow-hidden rounded-3xl border border-slate-700 bg-transparent"
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative flex h-44 w-44 items-center justify-center overflow-hidden rounded-full text-4xl font-bold text-white">
            ...
            {imageUrl ? (
              <Image
                ...
                height={100}
                alt={text || "Card image"}
                className="relative z-20 h-full w-full rounded-full object-cover"
              />
            ) : (
...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      />
      <motion.div
        className="absolute inset-0 rounded-2xl opacity-20 mix-blend-overlay group-hover/card:opacity-100"
        style={style}
      >
