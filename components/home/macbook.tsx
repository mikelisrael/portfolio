  ...
  return (
    ...
    >
      ...
      <div className="-mt-40 scale-[0.55] sm:-mt-20 sm:scale-75 md:mt-0 md:scale-100">
        ...
        />
        {/* Base area */}
        <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray">
          {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 h-96 w-[32rem] rounded-2xl bg-[#010101] p-2"
      >
